...
from signal_classification.models import deep_fir_tv_fc_fn, fc_fn, deep_cheb_fc_fn, deep_sep_fir_fc_fn, deep_fir_tv_zero
...
def run_training(L, train_mb_source, test_mb_source):
    ...
    with tf.Session() as sess:
        ...
        file.write("{},{},{},{}\n".format(FLAGS.model_type if FLAGS.zeros==0 else 'deep_cheb_zero',FLAGS.num_epochs,FLAGS.num_train, test_accuracy))
...
def main(_):
    ...
    if FLAGS.action == "train":
        ...
        G = graphs.Community(FLAGS.num_vertices, seed=FLAGS.seed)#, world_density = 0.1)
